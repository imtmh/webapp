  ...
  (e.site = e.fn.site = function(i) {
    ...
    return (
      (o = {
        ...
        console: function(e) {
          if (e) {
            if (void 0 === h.cache.console) return void o.error(m.console);
            ...
            (R = {
                ...
                R.get.settings(),
                  u
                    ...
                    : (void 0 !== A && A.invoke('destroy'),
                      R.verbose('Initializing form validation', P, p),
                      R.bindEvents(),
                      R.set.defaults(),
                      R.instantiate());
              },
                ...
                f.each(function() {
                  ...
                  i.hasClass(x.error) &&
                    ...
                    s
                      ...
                      : r
                        ? t.prop('checked', !1)
                        : (R.verbose('Resetting field value', t, a), t.val(''));
                });
              },
              reset: function() {
                f.each(function() {
                    ...
                    s
                      ...
                      : r
                        ? (R.verbose('Resetting checkbox value', n, a),
                          t.prop('checked', a))
                        : (R.verbose('Resetting field value', t, a), t.val(a)));
                });
              },
              determine: {
                isValid: function() {
              ...
              is: {
                bracketedRule: function(e) {
                  return e.type && e.type.match(p.regExp.bracket);
                },
              ...
              removeEvents: function() {
                P.off(T), f.off(T), v.off(T), f.off(T);
              },
              event: {
                field: {
                  keydown: function(t) {
                    ...
                    i == 27 &&
                      ...
                      t.ctrlKey ||
                        ...
                        (O ||
                          ...
                          R.submit(),
                          R.debug('Enter pressed on input submitting form')),
                        (O = !0));
                  },
                  keyup: function() {
                    O = !1;
                  ...
                  change: function(t) {
                    ...
                    o &&
                      ('change' == p.on ||
                        (i.hasClass(x.error) && p.revalidate)) &&
              ...
              get: {
                ancillaryValue: function(e) {
                  return (
                    ...
                    (void 0 !== e.value
                      ? e.value
                      : e.type.match(p.regExp.bracket)[1] + '')
                  );
                },
                ruleName: function(e) {
                  return R.is.bracketedRule(e)
                    ? e.type.replace(e.type.match(p.regExp.bracket)[0], '')
                    : e.type;
                },
                ...
                prompt: function(e, t) {
                  var n,
                    ...
                    o,
                    a = R.get.ruleName(e),
                    r = R.get.ancillaryValue(e),
                    s = e.prompt || p.prompt[a] || p.text.unspecifiedRule,
                    l = -1 !== s.search('{value}'),
                    c = -1 !== s.search('{name}');
                  return (
                    (c || l) && (i = R.get.field(t.identifier)),
                    ...
                    c &&
                      ((o =
                        ...
                        (n = i
                          ...
                          .eq(0)).length
                          ? n.text()
                          : i.prop('placeholder') || p.text.unspecifiedField),
                      (s = s.replace('{name}', o))),
                ...
                settings: function() {
                  if (e.isPlainObject(t)) {
                    var n = Object.keys(t);
                    n.length > 0 &&
                    (void 0 !== t[n[0]].identifier && void 0 !== t[n[0]].rules)
                      ? ((p = e.extend(!0, {}, e.fn.form.settings, c)),
                        (h = e.extend({}, e.fn.form.settings.defaults, t)),
                        R.error(p.error.oldSyntax, E),
                        R.verbose(
                      ...
                      : (t.fields &&
                          ...
                          (t.fields = R.get.fieldsFromShorthand(t.fields)),
                        (p = e.extend(!0, {}, e.fn.form.settings, t)),
                        (h = e.extend(
                          {},
                          e.fn.form.settings.defaults,
                          p.fields
                        )),
                        R.verbose('Extending settings', h, p));
                  } else
                    (p = e.fn.form.settings),
                      (h = e.fn.form.settings.defaults),
                      R.verbose('Using default form validation', h, p);
                  (k = p.namespace),
                    (b = p.metadata),
                    (y = p.selector),
                    (x = p.className),
                ...
                values: function(t) {
                  var n = {};
                  return (
                    (e.isArray(t) ? R.get.fields(t) : f).each(function(t, i) {
                      var o = e(i),
              ...
              add: {
                ...
                prompt: function(t, n) {
                  ...
                  (n = 'string' == typeof n ? [n] : n),
                    ...
                    i.addClass(x.error),
                    p.inline &&
                      (a || (o = p.templates.prompt(n)).appendTo(i),
                      o.html(n[0]),
                      a
                        ? R.verbose(
                        ...
                        : p.transition &&
                          ...
                          ? (R.verbose(
                            ...
                            o.transition(p.transition + ' in', p.duration))
                          : (R.verbose(
              ...
              remove: {
                rule: function(t, n) {
                  ...
                  if (void 0 == n)
                    return R.debug('Removed all rules'), void (h[t].rules = []);
                  void 0 != h[t] &&
                    e.isArray(h[t].rules) &&
              ...
              validate: {
                form: function(e, t) {
                  ...
                  if (((F = []), R.determine.isValid())) {
                    if (
                      (R.debug('Form has no validation errors, submitting'),
                      R.set.success(),
                      !0 !== t)
                    )
                      return p.onSuccess.call(E, e, n);
                  } else if (
                    (R.debug('Form has errors'),
                    R.set.error(),
                    p.inline || R.add.errors(F),
                    void 0 !== P.data('moduleApi') &&
                      e.stopImmediatePropagation(),
                    !0 !== t)
                  )
                    return p.onFailure.call(E, F, n);
                },
                field: function(t, n, i) {
                  (i = void 0 === i || i),
                    'string' == typeof t &&
                      (R.verbose('Validating field', t), (n = t), (t = h[t]));
                  ...
                  return (
                    t.identifier ||
                      ...
                      (t.identifier = o)),
                    a.prop('disabled')
                      ? (R.debug('Field is disabled. Skipping', o), (s = !0))
                      : t.optional && R.is.blank(a)
                        ? (R.debug('Field is optional and blank. Skipping', o),
                          (s = !0))
                    ...
                    s
                      ? (i && (R.remove.prompt(o, l), p.onValid.call(a)), !0)
                      : (i &&
                          ((F = F.concat(l)),
                          R.add.prompt(o, l),
                          p.onInvalid.call(a, l)),
                        !1)
                  );
                },
                rule: function(t, n) {
          ...
          o.each(function() {
            ...
            (d = {
              ...
              toggle: function(t) {
                var n =
                    void 0 !== t
                      ? 'number' == typeof t ? C.eq(t) : e(t).closest(v.title)
              ...
              get: {
                ...
                duration: function() {
                  return 'object' == typeof m.duration
                    ? f.is.active() ? m.duration.hide : m.duration.show
                    : m.duration;
                }
              },
              has: {
              ...
              get: {
                ...
                transition: function(e) {
                  return 'auto' == k.transition
                    ? w.is.upward(e) ? 'slide up' : 'slide down'
                    : k.transition;
                },
                userValues: function() {
                  var t = w.get.values();
              ...
              add: {
                label: function(t, n, i) {
                  ...
                  (o = e('<a />')
                    ...
                    w.has.label(t)
                      ? w.debug('Label already exists, skipping', r)
        ...
        return (
          o.each(function() {
            var d,
              ...
              C = 'module-' + b,
              w = (e(t), e(this)),
              k = (w.find(m.placeholder), w.find(m.icon), w.find(m.embed)),
              S = this,
              T = w.data(C);
            (d = {
              initialize: function() {
            ...
            (k = {
              ...
              observeChanges: function() {
                'MutationObserver' in t &&
                  ...
                  })).observe(j, { childList: !0, subtree: !0 }),
        ...
        return (
          a.each(function() {
            ...
            (y = {
              ...
              observeChanges: function() {
                'MutationObserver' in t &&
                  ((p = new MutationObserver(y.event.documentChanged)).observe(
                    n,
                ...
                x.popup
                  ...
                  x.popup
                    ...
                    : (v = x.inline
                        ...
                        : y.has.popup() ? y.get.offsetParent(a) : l),
                  v.is('html') &&
                    v[0] !== l[0] &&
          ...
          (o = {
            ...
            increment: function(e) {
              ...
              o.has.total()
                ...
                : ((n = (t = o.get.percent()) + (e = e || o.get.randomValue())),
                  100,
            ...
            get: {
              ...
              normalizedValue: function(e) {
                if (e < 0) return o.debug('Value cannot decrement below 0'), 0;
                if (o.has.total()) {
                  if (e > o.total)
                    return (
                      o.debug('Value cannot increment above total', o.total),
                      o.total
                    );
                } else if (e > 100)
                  return (
            ...
            remove: {
              ...
              success: function() {
                o.verbose('Removing success state'), y.removeClass(f.success);
              },
              warning: function() {
                o.verbose('Removing warning state'), y.removeClass(f.warning);
              },
              error: function() {
            ...
            set: {
              ...
              percent: function(e) {
                (e = 'string' == typeof e ? +e.replace('%', '') : e),
                  (e =
                    d.precision > 0
                      ? Math.round(e * (10 * d.precision)) / (10 * d.precision)
                      : Math.round(e)),
                  (o.percent = e),
                  o.has.total() ||
                    ((o.value =
                      d.precision > 0
                        ? Math.round(e / 100 * o.total * (10 * d.precision)) /
                          (10 * d.precision)
              ...
              success: function(e) {
                (e = e || d.text.success || d.text.active),
                  ...
                  o.complete(),
                  d.text.success
                    ? ((e = d.onLabelUpdate('success', e, o.value, o.total)),
                      o.set.label(e))
                    : ((e = d.onLabelUpdate('active', e, o.value, o.total)),
                      o.set.label(e)),
                  o.bind.transitionEnd(function() {
            ...
            update: {
              ...
              progress: function(e) {
                var t;
                !1 === (e = o.get.numericValue(e)) && o.error(p.nonNumeric, e),
          ...
          a.each(function() {
            ...
            (m = {
              ...
              set: {
                ...
                duration: function(e) {
                  (e = 'number' == typeof (e = e || v.duration) ? e + 'ms' : e),
                ...
                stageSize: function() {
                  var e = w.clone().addClass(y.loading),
                    ...
                    i =
                      'next' == v.width
                        ? n.outerWidth(!0)
                        : 'initial' == v.width ? w.width() : v.width,
                    o =
                      'next' == v.height
                        ? n.outerHeight(!0)
                        : 'initial' == v.height ? w.height() : v.height;
              ...
              flip: {
                ...
                over: function() {
                  !m.is.complete() || m.is.animating() || v.allowRepeats
                    ? m.is.animating()
                      ? m.queue('flip over')
        ...
        return (
          a.each(function() {
            ...
            (C = {
              ...
              repaint: function() {
                C.verbose('Forcing repaint event'), (j.style.display = 'none');
                j.offsetHeight;
              ...
              get: {
                direction: function() {
                  return F.hasClass(S.top)
                    ...
                    : F.hasClass(S.right)
                      ? S.right
                      : F.hasClass(S.bottom) ? S.bottom : S.left;
                },
                transition: function() {
                  var e,
                    t = C.get.direction();
              ...
              g
                ? (void 0 === z && C.initialize(), C.invoke(m))
                : (void 0 !== z && C.invoke('destroy'), C.initialize());
          }),
          void 0 !== o ? o : this
        );
      }),
          ...
          a.each(function() {
            ...
            (v = {
              ...
              determineContext: function() {
                0 !== (f = p.context ? e(p.context) : a).length ||
                  v.error(y.invalidContext, p.context, w);
              },
          ...
          a.each(function() {
            ...
            (h = {
              ...
              changeTab: function(n) {
                var i =
                    t.history && t.history.pushState && y.ignoreFirstLoad && P,
            ...
            (x = {
              ...
              delay: function(e) {
                ...
                i || (i = x.can.transition() ? x.get.direction() : 'static'),
                  ...
                  (n =
                    ('auto' == f.reverse && i == v.outward) || 1 == f.reverse
          ...
          (g = {
            ...
            should: {
              removeError: function() {
                return (
                  !0 === v.hideError || ('auto' === v.hideError && !g.is.form())
                );
              }
            },
            is: {
            ...
            get: {
              ...
              settings: function() {
                ...
                return (
                  ...
                  !1 === t
                    ? t
                    : void 0 !== t ? e.extend(!0, {}, t) : e.extend(!0, {}, v)
                );
              },
            ...
            (p = {
              ...
              bottomVisibleReverse: function(e) {
                ...
                if (
                  ...
                  t.bottomVisible
                    ? h.once || p.remove.occurred(i)
                    : p.get.occurred('bottomVisible') && p.execute(n, i),
                  void 0 === e)
                )
                  return !t.bottomVisible;
              },
              ...
              bottomPassedReverse: function(e) {
                ...
                if (
                  ...
                  t.bottomPassed
                    ? h.once || p.remove.occurred(i)
                    : p.get.occurred('bottomPassed') && p.execute(n, i),
                  void 0 === e)
                )
                  return !t.bottomPassed;
              },
