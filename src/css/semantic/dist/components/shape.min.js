        ...
        s.each(function() {
          ...
          (m = {
            ...
            instantiate: function() {
              m.verbose('Storing instance of module', m), (Z = m), C.data(w, Z);
            },
            destroy: function() {
            ...
            refresh: function() {
              m.verbose('Refreshing selector cache for', T),
                ...
                (F = e(this).find(b.side));
            },
            repaint: function() {
              m.verbose('Forcing repaint event');
              (W[0] || i.createElement('div')).offsetWidth;
            },
            ...
            is: {
              complete: function() {
                return F.filter('.' + y.active)[0] == f[0];
              },
              animating: function() {
            ...
            set: {
              ...
              duration: function(e) {
                (e = 'number' == typeof (e = e || p.duration) ? e + 'ms' : e),
              ...
              currentStageSize: function() {
                var e = C.find('.' + p.className.active),
                  t = e.outerWidth(!0),
                  i = e.outerHeight(!0);
              ...
              stageSize: function() {
                var e = C.clone().addClass(y.loading),
                  ...
                  n =
                    'next' == p.width
                      ? i.outerWidth(!0)
                      : 'initial' == p.width ? C.width() : p.width,
                  a =
                    'next' == p.height
                      ? i.outerHeight(!0)
                      : 'initial' == p.height ? C.height() : p.height;
                t.removeClass(y.active),
                  i.addClass(y.active),
                  e.insertAfter(C),
                  e.remove(),
                  'auto' != p.width &&
                    (C.css('width', n + p.jitter),
                    m.verbose('Specifying width during animation', n)),
                  'auto' != p.height &&
                    (C.css('height', a + p.jitter),
            ...
            flip: {
              up: function() {
                if (!m.is.complete() || m.is.animating() || p.allowRepeats)
            ...
            stage: {
              above: function() {
                ...
                m.verbose(
                  ...
                  W.css({ transform: 'translateZ(-' + e.depth.active + 'px)' }),
                  t.css({
                    transform:
              ...
              left: function() {
                ...
                m.verbose(
                  ...
                  W.css({ transform: 'translateZ(-' + n.depth.active + 'px)' }),
                  t.css({
                    transform:
                    ...
                    var o =
                      i != s
                        ? a +
                          ...
                          t[i + 1].slice(1)
                        : t;
                    if (e.isPlainObject(d[o]) && i != s) d = d[o];
                    else {
                      if (d[o] !== n) return (r = d[o]), !1;
                      if (!e.isPlainObject(d[a]) || i == s)
                        return d[a] !== n && ((r = d[a]), !1);
                      d = d[a];
                    }
                  })),
                e.isFunction(r) ? (l = r.apply(a, i)) : r !== n && (l = r),
                e.isArray(o)
                  ? o.push(l)
                  : o !== n ? (o = [o, l]) : l !== n && (o = l),
                r
            ...
            u
              ? (Z === n && m.initialize(), m.invoke(d))
              : (Z !== n && Z.invoke('destroy'), m.initialize());
        }),
        o !== n ? o : this
      );
    }),
