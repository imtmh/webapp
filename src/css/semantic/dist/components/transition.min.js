      ...
      return (
        a.each(function(i) {
          ...
          (w = {
            ...
            delay: function(n) {
              var e,
                t = w.get.animationDirection();
              t || (t = w.can.transition() ? w.get.direction() : 'static'),
                (n = void 0 !== n ? n : m.interval),
                (e =
                  ('auto' == m.reverse && t == g.outward) || 1 == m.reverse
                    ? (a.length - i) * m.interval
                    : i * m.interval),
                w.debug('Delaying animation by', e),
                setTimeout(w.animate, e);
            },
            animate: function(n) {
            ...
            get: {
                ...
                return 'object' == typeof i
                  ...
                  : 'function' == typeof t
                    ...
                    : 'string' == typeof e || 'number' == typeof e
                      ...
                      : 'object' == typeof e
                        ? n.extend({}, n.fn.transition.settings, e, {
                            animation: i
                          })
                        : 'function' == typeof e
                          ? n.extend({}, n.fn.transition.settings, {
              ...
              duration: function(n) {
                return (
                  !1 === (n = n || m.duration) &&
                    (n = C.css('animation-duration') || 0),
                  'string' == typeof n
                    ? n.indexOf('ms') > -1 ? parseFloat(n) : 1e3 * parseFloat(n)
                    : n
                );
              },
              displayType: function(n) {
              ...
              userStyle: function(n) {
                return (n = n || C.attr('style') || '').replace(
                  /display.*?;/,
                  ''
                );
              },
