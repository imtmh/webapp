    ...
    return (
      (s = {
        ...
        instantiate: function() {
          s.verbose('Storing instance of site', s), (h = s), p.data(b, s);
        },
        normalize: function() {
        ...
        console: function(e) {
          if (e) {
            if (h.cache.console === i) return void s.error(f.console);
        ...
        destroy: function() {
          s.verbose('Destroying previous site for', p), p.removeData(b);
        },
        cache: {},
      ...
      u
        ? (h === i && s.initialize(), s.invoke(l))
        : (h !== i && s.destroy(), s.initialize()),
      r !== i ? r : this
    );
  }),
    (e.site.settings = {
