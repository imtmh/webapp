        ...
        s.each(function(h) {
          ...
          (y = {
            initialize: function() {
              y.debug('Initializing dropdown', A),
                y.is.alreadySetup()
                  ? y.setup.reference()
                  : (y.setup.layout(),
                    A.values && y.change.values(A.values),
                    y.refreshData(),
                    y.save.defaults(),
                    y.restore.selected(),
                    y.create.id(),
            ...
            observe: {
              select: function() {
                y.has.input() &&
                  C.observe(z[0], { childList: !0, subtree: !0 });
              },
              menu: function() {
            ...
            bind: {
              ...
              touchEvents: function() {
                y.debug(
                  ...
                  B.on('touchstart' + F, O.item, y.event.item.mouseenter);
              },
                ...
                y.verbose('Binding mouse events'),
                  ...
                  y.is.searchSelection()
                    ...
                    : ('click' == A.on
                      ...
                      y.has.menuSearch()
                        ? z.on('blur' + F, O.search, y.event.search.blur)
                        : z.on('blur' + F, y.event.blur)),
                  B.on('mouseenter' + F, O.item, y.event.item.mouseenter)
              ...
              var t = e !== i ? e : y.get.query(),
                n = function() {
                  y.is.multiple() && y.filterActive(),
                    (e || (!e && 0 == y.get.activeItem().length)) &&
                      y.select.firstUnfiltered(),
                    y.has.allResultsFiltered()
                      ? A.onNoResults.call(G, t)
                        ? A.allowAdditions
                          ? A.hideAdditions &&
                            (y.verbose(
              ...
              y.has.query() &&
                ...
                $.each(function() {
                  ...
                  if ('both' == A.match || 'text' == A.match) {
                    if (-1 !== (t = String(y.get.choiceText(o, !1))).search(s))
                      return a.push(this), !0;
                    if ('exact' === A.fullTextSearch && y.exactSearch(n, t))
                      return a.push(this), !0;
                    if (!0 === A.fullTextSearch && y.fuzzySearch(n, t))
                      return a.push(this), !0;
                  }
                  if ('both' == A.match || 'value' == A.match) {
                    if (-1 !== (i = String(y.get.choiceValue(o, t))).search(s))
                      return a.push(this), !0;
                    if ('exact' === A.fullTextSearch && y.exactSearch(n, i))
                      return a.push(this), !0;
                    if (!0 === A.fullTextSearch && y.fuzzySearch(n, i))
                      return a.push(this), !0;
                  }
                })),
            ...
            change: {
              values: function(t) {
                A.allowAdditions || y.clear(),
                  y.debug('Creating dropdown with specified values', t),
                  y.setup.menu({ values: t }),
                  e.each(t, function(e, t) {
                    if (1 == t.selected)
                      return (
                        y.debug('Setting initial selection to', t.value),
                        y.set.selected(t.value),
                        !0
                      );
                  });
              }
              ...
              item: {
                ...
                click: function(t, i) {
                  var a = e(this),
                    ...
                    c = s.length > 0,
                    u = s.find(o).length > 0;
                  y.has.menuSearch() && e(n.activeElement).blur(),
                    u ||
                      (c && !A.allowCategorySelection) ||
                      (y.is.searchSelection() &&
                        (A.allowAdditions && y.remove.userAddition(),
                        y.remove.searchTerm(),
                        y.is.focusedOnSearch() || 1 == i || y.focusSearch(!0)),
                      A.useLabels ||
                        (y.remove.filteredItem(), y.set.scrollPosition(a)),
                      y.determine.selectAction.call(this, r, l));
                }
              },
              document: {
                keydown: function(e) {
                      ...
                      : t == I.rightArrow
                        ? (v && !s && n.first().addClass(T.active),
                          s &&
                            ...
                            c
                              ? u
                                ? d ? n.removeClass(T.active) : y.focusSearch()
                                : r
                                  ? i.next(O.siblingLabel).addClass(T.active)
                                  : i.addClass(T.active)
                              : i.next(O.siblingLabel).addClass(T.active),
                            e.preventDefault()))
              ...
              keydown: function(e) {
                ...
                if (y.is.inObject(t, I)) {
                  var n,
                    ...
                    s =
                      o.length > 0
                        ? o.siblings(':not(.' + T.filtered + ')').addBack()
                        : B.children(':not(.' + T.filtered + ')'),
                    r = o.children(O.menu),
                    l = o.closest(O.menu),
                    c =
                  ...
                  if (
                    (A.allowAdditions &&
                      ...
                      (t == I.enter || f) &&
                      v &&
                      (y.verbose('Selecting item from keyboard shortcut', o),
                    ...
                    if (
                      ((t == I.enter || f) &&
                        (t == I.enter && d && u && !A.allowCategorySelection
                          ? (y.verbose(
                      ...
                      d &&
                        (t == I.leftArrow &&
                          ...
                          l.closest(O.item).addClass(T.selected),
                          e.preventDefault()),
                        t == I.rightArrow &&
                          u &&
            ...
            get: {
              ...
              placeholderText: function() {
                return 'auto' != A.placeholder &&
                  'string' == typeof A.placeholder
                  ? A.placeholder
                  : z.data(D.placeholderText) || '';
              },
              text: function() {
                return H.text();
              },
              ...
              transition: function(e) {
                return 'auto' == A.transition
                  ? y.is.upward(e) ? 'slide up' : 'slide down'
                  : A.transition;
              },
              userValues: function() {
                var t = y.get.values();
              ...
              values: function() {
                ...
                return '' === e
                  ...
                  : !y.has.selectInput() && y.is.multiple()
                    ? 'string' == typeof e ? e.split(A.delimiter) : ''
                    : e;
              },
              ...
              inputEvent: function() {
                ...
                return (
                  ...
                  (e.oninput !== i
                    ? 'input'
                    : e.onpropertychange !== i ? 'propertychange' : 'keyup')
                );
              },
              ...
              item: function(t, n) {
                ...
                return (
                  (t =
                    t !== i
                      ? t
                      : y.get.values() !== i ? y.get.values() : y.get.text()),
            ...
            check: {
              maxSelections: function(e) {
                return (
                  !A.maxSelections ||
                  ((e = e !== i ? e : y.get.selectionCount()) >= A.maxSelections
            ...
            set: {
              ...
              tabbable: function() {
                y.is.searchSelection()
                  ...
                  : (y.debug('Added tabindex to dropdown'),
                    z.attr('tabindex') === i &&
                      (z.attr('tabindex', 0), B.attr('tabindex', -1)));
              },
              ...
              scrollPosition: function(e, t) {
                var n, a, o, s, r, l;
                (n = (e = e || y.get.selectedItem()).closest(O.menu)),
                  (a = e && e.length > 0),
                  (t = t !== i && t),
                  e &&
                    n.length > 0 &&
                    ...
                    (o = (s = n.scrollTop()) - n.offset().top + e.offset().top),
                    t || ((l = s + n.height() < o + 5), (r = o - 5 < s)),
              ...
              text: function(e) {
                'select' !== A.action &&
                  ('combo' == A.action
                    ? (y.debug('Changing combo button text', e, W),
                      A.preserveHTML ? W.html(e) : W.text(e))
                    : (e !== y.get.placeholderText() &&
              ...
              selectedLetter: function(t) {
                var n,
                  ...
                  a = !1;
                i.length > 0 &&
                  y.has.firstLetter(i, t) &&
                  ((n = i.nextAll($).eq(0)),
                  y.has.firstLetter(n, t) && (a = n)),
                  a ||
                    $.each(function() {
                  ...
                  a &&
                    ...
                    y.set.scrollPosition(a),
                    i.removeClass(T.selected),
                    a.addClass(T.selected),
                    A.selectOnKeydown &&
                      y.is.single() &&
                      y.set.selectedItem(a));
              },
              direction: function(e) {
                'auto' == A.direction
                  ? (y.remove.upward(),
                    y.can.openDownward(e)
                      ? y.remove.upward(e)
                      : y.set.upward(e),
                    y.is.leftward(e) ||
                      y.can.openRightward(e) ||
                      y.set.leftward(e))
              ...
              value: function(e, t, n) {
                ...
                if (o) {
                  ...
                  y.is.single() &&
                    ...
                    (Y = !0),
                    U.val(a),
                    !1 === A.fireOnInit && y.is.initialLoad()
                      ? y.debug(
            ...
            add: {
              label: function(t, n, i) {
                ...
                (a = e('<a />')
                  ...
                  y.has.label(t)
                    ? y.debug('Label already exists, skipping', s)
              ...
              optionValue: function(t) {
                ...
                U.find('option[value="' + y.escape.string(n) + '"]').length >
                  0 ||
                  (y.disconnect.selectObserver(),
                  y.is.single() &&
                ...
                (A.useLabels && y.has.maxSelections()) ||
                  ('' === e || a
                    ...
                    : (o
                        ...
                        : ((n = y.create.userChoice(e)).prependTo(B),
                          y.verbose(
                ...
                '' !== t
                  ? (e.isArray(o)
                    ...
                    !1 === A.fireOnInit && y.is.initialLoad()
                      ...
                      : A.onAdd.call(G, t, n, i),
                    y.set.value(a, t, n, i),
                    y.check.maxSelections())
                  : y.debug('Cannot select blank values from multiselect');
              }
            },
            remove: {
              active: function() {
              ...
              value: function(e, t, n) {
                ...
                y.has.selectInput()
                  ...
                  : (y.verbose('Removing from delimited values', e),
                    (i = (i = y.remove.arrayValue(e, a)).join(A.delimiter))),
                  !1 === A.fireOnInit && y.is.initialLoad()
                    ? y.verbose('No callback on initial load', A.onRemove)
                    : A.onRemove.call(G, e, t, n),
                  y.set.value(i, t, n),
                  y.check.maxSelections();
              },
              ...
              label: function(e, t) {
                var n = z
                  .find(O.label)
                  .filter(
                    '[data-' + D.value + '="' + y.escape.string(e) + '"]'
                  );
                y.verbose('Removing label', n), n.remove();
              },
                ...
                (t = t || z.find(O.label)),
                  ...
                  t.each(function() {
                    var t = e(this),
                      ...
                      a = n !== i ? String(n) : n,
                      o = y.is.userValue(a);
                    !1 !== A.onLabelRemove.call(t, n)
                      ? (y.remove.message(),
                        o
                          ? (y.remove.value(a), y.remove.label(a))
                          : y.remove.selected(a))
                      : y.debug('Label remove callback cancelled removal');
                  });
              },
              tabbable: function() {
                y.is.searchSelection()
            ...
            has: {
              ...
              minCharacters: function(e) {
                return (
                  !A.minCharacters ||
                  (e = e !== i ? String(e) : String(y.get.query())).length >=
                    A.minCharacters
                );
              },
              ...
              label: function(e) {
                ...
                return (
                  z
                    .find(O.label)
                    .filter(
                      '[data-' + D.value + '="' + y.escape.string(t) + '"]'
                    ).length > 0
                );
              },
            ...
            is: {
              ...
              verticallyScrollableContext: function() {
                var e = P.get(0) !== t && P.css('overflow-y');
                return 'auto' == e || 'scroll' == e;
              },
              horizontallyScrollableContext: function() {
                var e = P.get(0) !== t && P.css('overflow-X');
                return 'auto' == e || 'scroll' == e;
              }
            },
            can: {
              ...
              openDownward: function(e) {
                ...
                return (
                  ...
                  y.is.verticallyScrollableContext() &&
            ...
            f
              ? (J === i && y.initialize(), y.invoke(v))
              : (J !== i && J.invoke('destroy'), y.initialize());
        }),
        o !== i ? o : s
      );
    }),
