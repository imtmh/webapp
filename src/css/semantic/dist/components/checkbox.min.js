        ...
        c.each(function() {
          ...
          (h = {
              ...
              click: function(n) {
                ...
                t.is(k.input)
                  ...
                  : t.is(k.link)
                    ...
                    : (h.toggle(), w.focus(), n.preventDefault());
              },
              keydown: function(e) {
                var n = e.which,
                  t = 13,
            ...
            is: {
              ...
              radio: function() {
                return w.hasClass(f.radio) || 'radio' == w.attr('type');
              },
              indeterminate: function() {
              ...
              allowIndeterminate: function() {
                return h.is.indeterminate() && !h.should.forceCallbacks()
                  ? (h.debug(
                    ...
                    !1)
                  : !1 !== g.beforeIndeterminate.apply(I) ||
                      (h.debug(
            ...
            can: {
              change: function() {
                return !(
                  C.hasClass(f.disabled) ||
                  C.hasClass(f.readOnly) ||
                  w.prop('disabled') ||
                  w.prop('readonly')
                );
              },
            ...
            set: {
              ...
              checked: function() {
                h.verbose('Setting class to checked'),
                  C.removeClass(f.indeterminate).addClass(f.checked),
              ...
              unchecked: function() {
                h.verbose('Removing checked class'),
                  C.removeClass(f.indeterminate).removeClass(f.checked),
            ...
            uncheckOthers: function() {
              ...
              h.debug('Unchecking other radios', e), e.removeClass(f.checked);
            },
            toggle: function() {
              h.can.change()
                ? h.is.indeterminate() || h.is.unchecked()
                ...
                : h.is.radio() ||
                  h.debug('Checkbox is read-only or disabled, ignoring toggle');
            },
            ...
            invoke: function(n, t, o) {
              ...
              return (
                    ...
                    var a =
                      t != c
                        ? o +
                          ...
                          n[t + 1].slice(1)
                        : n;
                    if (e.isPlainObject(d[a]) && t != c) d = d[a];
                    else {
                      if (d[a] !== i) return (r = d[a]), !1;
                      if (!e.isPlainObject(d[o]) || t == c)
                        return d[o] !== i
                          ? ((r = d[o]), !1)
                ...
                e.isFunction(r) ? (l = r.apply(o, t)) : r !== i && (l = r),
                e.isArray(a)
                  ? a.push(l)
                  : a !== i ? (a = [a, l]) : l !== i && (a = l),
                r
