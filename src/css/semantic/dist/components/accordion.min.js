        ...
        a.each(function() {
          ...
          (g = {
            ...
            toggle: function(n) {
              var t =
                  n !== i
                    ? 'number' == typeof n ? x.eq(n) : e(n).closest(h.title)
            ...
            open: function(n) {
              var t =
                ...
                o = t.next(F),
                a = o.hasClass(m.animating);
              o.hasClass(m.active) || a
                ? g.debug('Accordion already open, skipping', o)
            ...
            internal: function(n, t) {
              if ((g.debug('Changing internal', n, t), t === i)) return g[n];
              e.isPlainObject(n) ? e.extend(!0, g, n) : (g[n] = t);
            },
            debug: function() {
              !f.silent &&
                f.debug &&
            ...
            l
              ? (q === i && g.initialize(), g.invoke(c))
              : (q !== i && q.invoke('destroy'), g.initialize());
        }),
        o !== i ? o : this
      );
    }),
