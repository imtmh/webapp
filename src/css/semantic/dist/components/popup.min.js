    ...
    (t.fn.popup = function(i) {
      ...
      return (
        a.each(function() {
          ...
          (y = {
            initialize: function() {
              y.debug('Initializing', A),
                y.createID(),
                y.bind.events(),
                !y.exists() && C.preserve && y.create(),
                C.observeChanges && y.observeChanges(),
                y.instantiate();
            },
            instantiate: function() {
              y.verbose('Storing instance', y), (W = y), A.data(O, W);
            },
            observeChanges: function() {
              'MutationObserver' in e &&
                ((v = new MutationObserver(y.event.documentChanged)).observe(
                  o,
            ...
            refresh: function() {
              C.popup
                ? (a = t(C.popup).eq(0))
                : C.inline && ((a = R.nextAll(T.popup).eq(0)), (C.popup = a)),
                C.popup
            ...
            event: {
              start: function(e) {
                ...
                clearTimeout(y.hideTimer),
                  V || (y.showTimer = setTimeout(y.show, o));
              },
              end: function() {
                var e = t.isPlainObject(C.delay) ? C.delay.hide : C.delay;
                clearTimeout(y.showTimer),
                  (y.hideTimer = setTimeout(y.hide, e));
              },
            ...
            create: function() {
              ...
              e || n || o
                ? (y.debug('Creating pop-up html'),
                  e || (e = C.templates.popup({ title: o, content: n })),
                  (a = t('<div/>')
                    .addClass(P.popup)
                    .data(k.activator, A)
                    .html(e)),
                  ...
                  y.refresh(),
                  y.set.variation(),
                  C.hoverable && y.bind.popup(),
                  C.onCreate.call(a, M))
                : 0 !== R.next(T.popup).length
                  ? (y.verbose('Pre-existing popup found'),
                    (C.inline = !0),
                    (C.popup = R.next(T.popup).data(k.activator, A)),
                    y.refresh(),
                    C.hoverable && y.bind.popup())
                  : C.popup
                    ? (t(C.popup).data(k.activator, A),
            ...
            createID: function() {
              (w = (Math.random().toString(16) + '000000000').substr(2, 8)),
                (b = '.' + w),
                y.verbose('Creating unique id for element', w);
            },
            toggle: function() {
            ...
            show: function(t) {
              if (
                ((t = t || function() {}),
                y.debug('Showing pop-up', C.transition),
                y.is.hidden() && (!y.is.active() || !y.is.dropdown()))
              ) {
                if ((y.exists() || y.create(), !1 === C.onShow.call(a, M)))
                  return void y.debug(
                    'onShow callback returned false, cancelling popup animation'
                  );
                C.preserve || C.popup || y.refresh(),
                  a &&
                    y.set.position() &&
                    (y.save.conditions(),
                    C.exclusive && y.hideAll(),
                    y.animate.show(t));
              }
            },
            hide: function(t) {
              if (
                ((t = t || function() {}), y.is.visible() || y.is.animating())
              ) {
                if (!1 === C.onHide.call(a, M))
                  return void y.debug(
            ...
            exists: function() {
              return (
                !!a &&
                (C.inline || C.popup ? y.has.popup() : a.closest(D).length >= 1)
              );
            },
            ...
            save: {
              conditions: function() {
                (y.cache = { title: A.attr('title') }),
                  y.cache.title && A.removeAttr('title'),
                  ...
                  A.transition('is supported')
                    ? (y.set.visible(),
                      a.transition({
                        ...
                        duration: C.duration,
                        onComplete: function() {
                          y.bind.close(), e.call(a, M), C.onVisible.call(a, M);
                        }
                      }))
                  ...
                  !1 !== C.onHide.call(a, M)
                    ? C.transition &&
                      ...
                      ? a.transition({
                          ...
                          verbose: C.verbose,
                          onComplete: function() {
                            y.reset(), e.call(a, M), C.onHidden.call(a, M);
                          }
                        })
                      : y.error(x.noTransition)
                    : y.debug(
            ...
            get: {
              html: function() {
                return A.removeData(k.html), A.data(k.html) || C.html;
              },
              title: function() {
                return A.removeData(k.title), A.data(k.title) || C.title;
              },
              content: function() {
                return (
                  A.removeData(k.content),
                  A.data(k.content) || A.attr('title') || C.content
                );
              },
              variation: function() {
                return (
                  A.removeData(k.variation), A.data(k.variation) || C.variation
                );
              },
              popup: function() {
                return a;
              ...
              distanceFromBoundary: function(t, e) {
                ...
                return (
                  ...
                  t &&
                    ...
                    y.verbose('Distance from boundaries determined', t, i)),
                  i
                );
              },
              offsetParent: function(e) {
                var o = (e !== n ? e[0] : A[0]).parentNode,
                  i = t(o);
                if (o)
                  for (
              ...
              nextPosition: function(t) {
                ...
                return (
                  N ||
                    ...
                    (N = y.get.positions())),
                  y.debug('Recording last position tried', t),
                  (N[t] = !0),
                  'opposite' === C.prefer &&
                    ((s = (s = [
                      {
            ...
            set: {
              position: function(t, e) {
                if (0 !== R.length && 0 !== a.length) {
                  ...
                  if (
                    ((e = e || y.get.calculations()),
                    (t = t || A.data(k.position) || C.position),
                    (o = A.data(k.offset) || C.offset),
                    (i = C.distanceAway),
                    (r = e.target),
                    (s = e.popup),
                    (p = e.parent),
                    0 === r.width && 0 === r.height && !y.is.svg(r.element))
                  )
                    return (
                  ...
                  switch ((C.inline &&
                    ...
                    'left center' == t || 'right center' == t
                      ...
                      : 'top left' == t || 'top center' == t || 'top right' == t
                        ...
                        : ((o += r.margin.left), (i += r.margin.top))),
                  y.debug('Determining popup position from calculations', t, e),
                  y.is.rtl() &&
                    ((t = t.replace(/left|right/g, function(t) {
                      return 'left' == t ? 'right' : 'left';
                    })),
                    y.debug('RTL: Popup position updated', t)),
                  H == C.maxSearchDepth &&
                  ...
                  if (
                    (l === n && y.error(x.invalidPosition, t),
                    ...
                    a
                      ...
                      .addClass(P.loading),
                    (u = y.get.popupOffset()),
                    (c = y.get.distanceFromBoundary(u, e)),
                    y.is.offstage(c, t))
                  ) {
                    if (
                      (y.debug('Position is outside viewport', t),
                      H < C.maxSearchDepth)
                    )
                      return (
                        H++,
                        (t = y.get.nextPosition(t)),
                        y.debug('Trying new position', t),
                        !!a && y.set.position(t, e)
                      );
                    if (!C.lastResort)
                      return (
                        y.debug(
                        ...
                        y.error(x.cannotPlace, M),
                        y.remove.attempts(),
                        y.remove.loading(),
                        y.reset(),
                        C.onUnplaceable.call(a, M),
                        !1
                      );
                    y.debug('No position found, showing with last position');
                  }
                  return (
                    y.debug('Position is on stage', t),
                    y.remove.attempts(),
                    y.remove.loading(),
                    C.setFluidWidth && y.is.fluid() && y.set.fluidWidth(e),
                    !0
                  );
                }
                y.error(x.notFound);
              ...
              variation: function(t) {
                (t = t || y.get.variation()) &&
                  y.has.popup() &&
                  (y.verbose('Adding variation to popup', t), a.addClass(t));
              },
              visible: function() {
                A.addClass(P.visible);
              }
            },
            remove: {
              loading: function() {
              ...
              variation: function(t) {
                (t = t || y.get.variation()) &&
                  (y.verbose('Removing variation', t), a.removeClass(t));
              },
              visible: function() {
                A.removeClass(P.visible);
              },
              attempts: function() {
            ...
            bind: {
              events: function() {
                y.debug('Binding popup events to module'),
                  'click' == C.on && A.on('click' + E, y.toggle),
                  'hover' == C.on && A.on('touchstart' + E, y.event.touchstart),
                  y.get.startEvent() &&
                    A.on(y.get.startEvent() + E, y.event.start).on(
                      y.get.endEvent() + E,
                      y.event.end
                    ),
                  C.target && y.debug('Target set to element', R),
                  p.on('resize' + b, y.event.resize);
              },
              popup: function() {
                y.verbose('Allowing hover events on popup to prevent closing'),
                  a &&
                    y.has.popup() &&
                    a
                      .on('mouseenter' + E, y.event.start)
                      .on('mouseleave' + E, y.event.end);
              },
              close: function() {
                (!0 === C.hideOnScroll ||
                  ('auto' == C.hideOnScroll && 'click' != C.on)) &&
                  y.bind.closeOnScroll(),
                  'hover' == C.on && V && y.bind.touchClose(),
                  'click' == C.on && C.closable && y.bind.clickaway();
              },
              closeOnScroll: function() {
                y.verbose('Binding scroll close event to document'),
                  j.one(y.get.scrollEvent() + b, y.event.hideGracefully);
              },
              touchClose: function() {
                y.verbose('Binding popup touchclose event to document'),
                  s.on('touchstart' + b, function(t) {
                    y.verbose('Touched away from popup'),
                      y.event.hideGracefully.call(M, t);
                  });
              },
              clickaway: function() {
                y.verbose('Binding popup close event to document'),
                  s.on('click' + b, function(t) {
            ...
            is: {
              ...
              active: function() {
                return A.hasClass(P.active);
              },
              animating: function() {
                return a !== n && a.hasClass(P.animating);
              },
              fluid: function() {
                return a !== n && a.hasClass(P.fluid);
              },
              visible: function() {
                return a !== n && a.hasClass(P.popupVisible);
              },
              dropdown: function() {
                return A.hasClass(P.dropdown);
              },
              hidden: function() {
                return !y.is.visible();
              },
            ...
            g
              ? (W === n && y.initialize(), y.invoke(f))
              : (W !== n && W.invoke('destroy'), y.initialize());
        }),
        r !== n ? r : this
      );
    }),
