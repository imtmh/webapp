  ...
  (e.fn.progress = function(t) {
    ...
    return (
      o.each(function() {
        ...
        (o = {
          initialize: function() {
            o.debug('Initializing progress bar', g),
              o.set.duration(),
          ...
          instantiate: function() {
            o.verbose('Storing instance of progress', o), (P = o), w.data(x, o);
          },
          destroy: function() {
          ...
          read: {
            metadata: function() {
              ...
              e.percent &&
                (o.debug('Current percent value set from metadata', e.percent),
            ...
            settings: function() {
              !1 !== g.total &&
                (o.debug('Current total set in settings', g.total),
                o.set.total(g.total)),
                !1 !== g.value &&
                  (o.debug('Current value set in settings', g.value),
                  o.set.value(g.value),
                  o.set.progress(o.value)),
                !1 !== g.percent &&
                  (o.debug('Current percent set in settings', g.percent),
                  o.set.percent(g.percent));
            }
          },
          bind: {
          ...
          get: {
            text: function(e) {
              var t = o.value || 0,
                n = o.total || 0,
                r = T ? o.get.displayPercent() : o.percent || 0,
                a = o.total > 0 ? n - t : 100 - r;
              return (
                (e = e || ''),
                (e = e
                  .replace('{value}', t)
            ...
            normalizedValue: function(e) {
              ...
              if (o.has.total()) {
                ...
                return o.debug('Value cannot increment above 100 percent'), 100;
              return e;
            },
            updateInterval: function() {
              return 'auto' == g.updateInterval ? g.duration : g.updateInterval;
            },
            randomValue: function() {
              return (
                o.debug('Generating random increment percentage'),
                Math.floor(Math.random() * g.random.max + g.random.min)
              );
            },
            ...
            displayPercent: function() {
              var e = y.width(),
                t = w.width(),
                n =
                  e > parseInt(y.css('min-width'), 10)
                    ? e / t * 100
                    : o.percent;
              return g.precision > 0
                ? Math.round(n * (10 * g.precision)) / (10 * g.precision)
                : Math.round(n);
            },
            percent: function() {
              return o.percent || 0;
          ...
          remove: {
            ...
            active: function() {
              o.verbose('Removing active state'), w.removeClass(v.active);
            },
            success: function() {
              o.verbose('Removing success state'), w.removeClass(v.success);
            },
            warning: function() {
              o.verbose('Removing warning state'), w.removeClass(v.warning);
            },
            error: function() {
              o.verbose('Removing error state'), w.removeClass(v.error);
            }
          },
          set: {
            barWidth: function(e) {
            ...
            duration: function(e) {
              (e = 'number' == typeof (e = e || g.duration) ? e + 'ms' : e),
            ...
            percent: function(e) {
              (e = 'string' == typeof e ? +e.replace('%', '') : e),
                (e =
                  g.precision > 0
                    ? Math.round(e * (10 * g.precision)) / (10 * g.precision)
                    : Math.round(e)),
                (o.percent = e),
                o.has.total() ||
                  ((o.value =
                    g.precision > 0
                      ? Math.round(e / 100 * o.total * (10 * g.precision)) /
                        (10 * g.precision)
                ...
                o.set.labelInterval(),
                o.set.labels(),
                g.onChange.call(E, e, o.value, o.total);
            },
              ...
              100 === (e = e !== r ? e : o.percent)
                ...
                : e > 0
                  ? (o.verbose('Adjusting active progress bar label', e),
                    o.set.active())
                  : (o.remove.active(), o.set.label(g.text.active));
            },
            barLabel: function(e) {
              e !== r
                ? V.text(o.get.text(e))
                : 'ratio' == g.label && o.total
                  ? (o.verbose('Adding ratio to bar label'),
                    V.text(o.get.text(g.text.ratio)))
                  : 'percent' == g.label &&
                    (o.verbose('Adding percentage to bar label'),
                    V.text(o.get.text(g.text.percent)));
            },
            active: function(e) {
              (e = e || g.text.active),
                o.debug('Setting active state'),
                g.showActivity && !o.is.active() && w.addClass(v.active),
                o.remove.warning(),
                o.remove.error(),
                o.remove.success(),
                (e = g.onLabelUpdate('active', e, o.value, o.total)) &&
                  o.set.label(e),
                o.bind.transitionEnd(function() {
                  g.onActive.call(E, o.value, o.total);
                });
            },
            success: function(e) {
              (e = e || g.text.success || g.text.active),
                ...
                o.complete(),
                g.text.success
                  ? ((e = g.onLabelUpdate('success', e, o.value, o.total)),
                    o.set.label(e))
                  : ((e = g.onLabelUpdate('active', e, o.value, o.total)),
                    o.set.label(e)),
                o.bind.transitionEnd(function() {
                  g.onSuccess.call(E, o.total);
                });
            },
            warning: function(e) {
              (e = e || g.text.warning),
                ...
                o.remove.error(),
                o.complete(),
                (e = g.onLabelUpdate('warning', e, o.value, o.total)) &&
                  o.set.label(e),
                o.bind.transitionEnd(function() {
                  g.onWarning.call(E, o.value, o.total);
                });
            },
            error: function(e) {
              (e = e || g.text.error),
                ...
                o.remove.warning(),
                o.complete(),
                (e = g.onLabelUpdate('error', e, o.value, o.total)) &&
                  o.set.label(e),
                o.bind.transitionEnd(function() {
                  g.onError.call(E, o.value, o.total);
                });
            },
          ...
          update: {
            ...
            progress: function(e) {
              var t;
              !1 === (e = o.get.numericValue(e)) && o.error(b.nonNumeric, e),
                ...
                e.each(t, function(n, a) {
                  var i =
                    n != s
                      ...
                      : t;
                  if (e.isPlainObject(u[i]) && n != s) u = u[i];
                  else {
                    if (u[i] !== r) return (l = u[i]), !1;
                    if (!e.isPlainObject(u[a]) || n == s)
                      return u[a] !== r
                        ? ((l = u[a]), !1)
                        : (o.error(b.method, t), !1);
                    u = u[a];
                  }
                })),
              e.isFunction(l) ? (c = l.apply(i, n)) : l !== r && (c = l),
              e.isArray(a)
                ? a.push(c)
                : a !== r ? (a = [a, c]) : c !== r && (a = c),
              l
          ...
          u
            ? (P === r && o.initialize(), o.invoke(c))
            : (P !== r && P.invoke('destroy'), o.initialize());
      }),
      a !== r ? a : this
    );
  }),
